...
(***********************************************************************************)
(*                                                                                 *)
(* The TEMPLATEPROJECT project                                                     *)
(*                                                                                 *)
(* Copyright (c) 2020, Mattia Piazza, Mattia Piccininit, Enrico Bertolazzi and     *)
(* Francesco Biral                                        )                        *)
(*                                                                                 *)
(* The TEMPLATEPROJECT project and its components are supplied under the terms     *)
(* of the open source BSD 2-Clause License. The contents of the TEMPLATEPROJECT    *)
...
///
/// file: TemplateProject.hh
///

#pragma once

#ifndef INCLUDE_TEMPLATEPROJECT
#define INCLUDE_TEMPLATEPROJECT

// Print TemplateProject errors
#ifndef TEMPLATEPROJECT_ERROR
#define TEMPLATEPROJECT_ERROR(MSG)                \
  {                                     \
...
// Check for TEMPLATEPROJECT errors
#ifndef TEMPLATEPROJECT_ASSERT
#define TEMPLATEPROJECT_ASSERT(COND, MSG) \
  if (!(COND))                  \
  TEMPLATEPROJECT_ERROR(MSG)
#endif
